...
import 'package:bucks_app/ui/widget/custom_button_widget.dart';
import 'package:bucks_app/ui/widget/custom_text_field.dart';
import 'package:bucks_app/ui/widget/custom_text_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          CustomTextField(
            textEditingController:
                getIt<VerificationCodeProvider>().confirmNewPassController,
