                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                //'${value.list[index].productName!}'.substring(0,40),
                                             Text(
                                               '${value.list[index].productName!.length > 40 ?value.list[index].productName!.substring(0,40) : value.list[index].productName!}',
                                                //  stepGranularity: 5,
                                                  softWrap: true,
                                                  maxLines: 5,
                                                  overflow:
